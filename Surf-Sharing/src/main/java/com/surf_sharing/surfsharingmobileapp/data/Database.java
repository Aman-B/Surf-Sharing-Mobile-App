...
public class Database {
     ...
     */
    public static boolean postLift(final String seatsAvailable, final String destination, final String date, final String time) {
            ...
            usersRef.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot snapshot) {
                    ...
                    try
                    {
                        ...
                        String userCar = (String) snapshot.child("car").getValue();
    ...
    /**
     * Function to update the values of the current driver, may want to change
     * the return type from 'void' to some relevant return type e.g.
     * 'DatabaseError'
     */
    public static boolean setDriverValue(Driver newDriverValue) {
        ...
        else
        {
            ...
            Map<String,Object> mapChild = new HashMap<String, Object>();
            mapChild.put("name", newDriverValue.name);
            mapChild.put("age", newDriverValue.age);
            mapChild.put("gender", newDriverValue.gender);
            mapChild.put("email", newDriverValue.email);
            mapChild.put("type", newDriverValue.type);
            mapChild.put("phone", newDriverValue.phone);
            mapChild.put("bio", newDriverValue.bio);
            mapChild.put("car", newDriverValue.car);
            mapChild.put("licence number", newDriverValue.licence);
            mapChild.put("driver registration", newDriverValue.registration);
            mapChild.put("address", newDriverValue.address);
            mapChild.put("lifts", "");

            if(newDriverValue.image == null){
                mapChild.put("image", "");
                Log.i("Saving", "nothing");

            }
            else {
                mapChild.put("image", newDriverValue.image);
                Log.i("Saving", "image");
            }
    ...
    public static void makeLiftRequest(final String liftId, final String userName, final String userPhone, final String pickupLocationStreet1, final String pickupLocationStreet2, final String pickupLocationCounty, final String boardLength) {
            ...
            usersRef.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot snapshot) {
                    ...
                    try
                    {
                        ...
                        //add pickup location details and board length
                        passengerDetailMap.put("name", userName);
                        passengerDetailMap.put("phone", userPhone);
                        passengerDetailMap.put("pickup street 1", pickupLocationStreet1);
                        passengerDetailMap.put("pickup street 2", pickupLocationStreet2);
                        passengerDetailMap.put("pickup county", pickupLocationCounty);
    ...
    public static boolean upgradeToDriver(String carModel, String driverRegistration, String licenceNumber, String maxPassengers) {
        ...
        else
        {
            ...
            Map<String,Object> mapChild = new HashMap<String, Object>();
            mapChild.put("car", carModel);
            mapChild.put("licence number", licenceNumber);
            mapChild.put("driver registration", driverRegistration);
